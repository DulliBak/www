...
<div class="main">
      <img src="../sub5/common/images/visual.jpg" alt="미디어센터 이미지" />
      <h3>미디어센터</h3>
    </div>
    ...
    <div class="subNav">
      <ul>
        ...
        <li><a href="../sub5/sub5_2.html">CF</a></li>
...
?>
	...
	<div id="col2">        
		...
		<div id="list_top_title">
			<ul>
				<li id="list_title1" class="hidden">번호</li>
				<li id="list_title2" class="hidden">제목</li>
				<li id="list_title3" class="hidden">작성자</li>
				<li id="list_title4" class="hidden">날짜</li>
				<li id="list_title5" class="hidden">조회</li>
			</ul>		
		</div>
